...
public class Kamion extends MotornoVozilo {
    public Kamion(int cena, int godinaProizvodnje, ArrayList<Tocak> tockovi) {
        super(cena, godinaProizvodnje, tockovi);
    }

    public Kamion(int cena, int godinaProizvodnje, Tocak... tockovi) {
        super(cena, godinaProizvodnje, tockovi);
    }
    ...
    public void ubaciRezervnu() {
        Tocak rezerva = new Tocak(0, 5000);
        while (getTockovi().size() < 10) {
